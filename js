...
import fetchSimpleMap from '@salesforce/apex/lwcController.fetchSimpleMap';
import fetchListMap from '@salesforce/apex/lwcController.fetchListMap';
import fetchNestedMap from '@salesforce/apex/lwcController.fetchNestedMap';
